function Standings(){
    return (
        <ol class="ml-6 mr-2 overflow-y-scroll flex-grow scroll-smooth mb-4
          ...
          <li class="m-3 bg-slate-950 text-yellow-500">
            <div class="flex flex-row justify-between">
              ...
              <div class="flex-1 text-center">
                <img class="h-5 rounded-md items-center align-middle justify-center flex-1" src="public/premierleaguelogoimages.jpg" />
              </div>
              <p class="flex-1 text-center">Chelsea</p>
              <p class="flex-1 text-center"> 30</p>
              <p class="flex-1 text-center">10</p>
              <p class="flex-1 text-center">2 </p>
              <p class="flex-1 text-center">1 </p>
